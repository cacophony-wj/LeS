...
Killmoves on the player are bugged due to the power levels of enemies. You need to choose the bottom menu, then import the "NoKillmovesOnPlayer" profile.
