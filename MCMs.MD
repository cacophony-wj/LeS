...
This can be pretty laggy with the _Devious_ set up so you might just disable it. The only thing you really need to make sure of is that you've got a dodge key you like. I configured everything else.
