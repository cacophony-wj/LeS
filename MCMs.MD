...
I do have a bit of a warning here however. Although distribution is rather rare, there are still a few skimpy outfits sprinkled throughout the list. I enabled this option because it is one of my most commonly requested features, and I also enjoy seeing a nice sexy outfit now and again myself. I promise they are not too over the top. To be more specific, the Khajiit caravans sell extremely slooty armors from _BD's Armor Replacer_ (which are basically bikinis from _TAWOBA_) and some of the skimpier outfits from _The Book of UUNP_ can sometimes be found on NPCs. I wished to make them only craftable or purchasable, but it turns out the guy who made that mod preferred to create a ridiculous abundance of sublists and craftable conditions to ensure nobody could easily edit it rather than make certain basic features were complete like, I dunno, disabling the ankle slot on a set of high heels. Nice priorities, Holmes!
