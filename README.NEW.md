...
- [Installation](#installation)
	...
	- [_Light But Sexy_ vs. _Light But Kinky_, How Do I Choose?](#light-but-sexy-vs-light-but-kinky-how-do-i-choose)
	...
	- [Best Save Practices: VERY IMPORTANT!](#best-save-practices-very-important)
...
## _Light But Sexy_ vs. _Light But Kinky_, How Do I Choose?
...
_Light But Sexy_ is the primary list, primarily intended to offer the option to have sex with attractive people as you play through a significantly modded Skyrim. Those choosing to play male characters or non-submissive females should choose this option so they don't find themselves intruded upon. The signature mod is [SexLab Eager NPCs (SLEN)](https://www.loverslab.com/files/file/2182-sexlab-eager-npcs/) which uses a rudimentary seduction system to improve your relationship with others via sex. [SexLab Defeat](https://www.loverslab.com/files/file/286-sexlab-defeat/), although fairly buggy as a death alternative, is also included to make combat sacrifices an option. Do note that I also include [BakaFactory's Defeat Patch](https://www.patreon.com/posts/sexlab-defeat-1-32912602) to improve the scripting and animations.

_Light But Kinky_ is the sublist for the well, kinky among us, and it is all about the [Deviously Cursed Loot](https://www.loverslab.com/files/file/5924-deviously-cursed-loot-se-beta-2/). Basically you will be fighting against magical traps that lock you in various restraining devices with little hope of escape, making yourself available to be exploited by anyone who might happen to be around. Given that [Devious Devices](https://www.loverslab.com/topic/99700-devious-devices-se-43/) (the BDSM framework that makes this mod possible) has no male body models (or only very limited ones) and you will find yourself having a lot of shall we say, "surprise" sex, this modlist is only recommended for female submissive characters. _Cursed Loot_ also has a death and surrender alternative with of course further bondage options. In addition, monster and other sex is included via... various mods. :sweat:
...
This section goes into further detail about invididual mod setups in the modlist and, while entertaining, not strictly necessary if you just want to play the game. Keep in mind that I basically paraphrased from the _Lotus_ README.
...
## Best Save Practices: VERY IMPORTANT!

Do one of these, in order of least safe to most safe.
...
5. **The most important thing to remember is that you can NOT "save scum" (load and save, load and save, seconds apart to get the best result) like you can in an unmodded game.** You will almost guarantee crashing and/or save corruption if you do this.
