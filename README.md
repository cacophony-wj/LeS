...
As a final note, at the end of the list should be an all-caps file named `DISABLE TO REMOVE ALL UNDIES.esp`. This is the file that controls whether the enemies you loot are wearing underwear or going commando. If you wish to have them in underwear when you loot them, leave it alone. Don't worry, you can still pilfer the panties for a peek, pervert. You will need to pay attention to the "Undressing" options in the MCM, otherwise the underwear will also stay on during sex. However, if you wish them to go commando, simply uncheck it. (Some of the underwear is rather unimmersive for a harsh Nordic environment.) This CANNOT be changed mid-game, or most people of Skyrim will be walking around naked! 
